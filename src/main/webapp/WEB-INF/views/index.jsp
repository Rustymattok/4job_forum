...
<header>
    <div class="header js-header js-dropdown">
                ...
                <div class="dropdown dropdown--design-01" data-dropdown-list="notification">
                    <div>
                        ...
                        <a href="#">
                            ...
                            <p>Earned Badge . 19 feb, 17<span><img src="../../resources/fonts/icons/badges/Lets_talk.svg" alt="Lets Talk">Lets Talk</span></p>
                        </a>
                        <a href="#">
                            <i class="icon-Badge"></i>
                            <p>Earned Badge . 21 feb, 17<span><img src="../../resources/fonts/icons/badges/Intermediate.svg" alt="Intermediate">Intermediate</span></p>
                        </a>
                        <a href="#">
        ...
        <div class="header__offset-btn">
            <a href="<c:url value="/newtopic"/>"><img src="../../resources/fonts/icons/main/New_Topic.svg" alt="New Topic"></a>
        </div>
    </div>
</header>
    <main>
                ...
                <div class="posts__body">
                    <div class="posts__item bg-f2f4f6">
                        <div class="posts__section-left">
                            ...
                            <div class="posts__users">Vladimir</div>
                        </div>
                        <div class="posts__section-right">
                            <div class="posts__users">
                               <%--//todo Include max 3 users who reply--%>
                                <div>
                                    <a href="#" class="avatar"><img src="../../resources/fonts/icons/avatars/L.svg" alt="avatar"></a>
                                </div>
                                <div>
                                    <a href="#" class="avatar"><img src="../../resources/fonts/icons/avatars/T.svg" alt="avatar"></a>
                                </div>
                            </div>
                            <%--size of comments--%>
